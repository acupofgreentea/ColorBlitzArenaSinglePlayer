...
public abstract class CharacterAnimationControllerBase : MonoBehaviour
{
...
public struct AnimationHashKeys
{
    ...
    public static readonly int IsSpeedBoostHashKey = Animator.StringToHash("IsSpeedBoost");
    public static readonly int IsStunHashKey = Animator.StringToHash("IsStun");
    public static readonly int PunchHashKey = Animator.StringToHash("Punch");
    public static readonly int PunchRandomMultpHashKey = Animator.StringToHash("PunchRandomMultp");
}
